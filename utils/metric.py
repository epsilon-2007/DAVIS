...
def get_curve(known, novel, method=None):
    tp, fp, fpr_at_tpr95 = dict(), dict(), dict()
    num_k, num_n = known.shape[0], novel.shape[0]
...
def compute_traditional_ood(known, novel, out_datasets, method = 'energy'):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Detecting Out-of-distribution examples in neural networks')
