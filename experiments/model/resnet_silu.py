...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        out = self.layer3(out)
        out = self.layer4(out)
        return out # [batch_size, 512, 4, 4]


def resnet18_silu(**kwargs):
    return ResNet(BasicBlock, [2, 2, 2, 2], **kwargs)

def resnet34_silu(**kwargs):
    return ResNet(BasicBlock, [3, 4, 6, 3], **kwargs)

def resnet50_silu(**kwargs):
    return ResNet(Bottleneck, [3, 4, 6, 3], **kwargs)

def resnet101_silu(**kwargs):
    return ResNet(Bottleneck, [3, 4, 23, 3], **kwargs)


model_dict = {
    'resnet18_silu':  [resnet18_silu, 512],
    'resnet34_silu':  [resnet34_silu, 512],
    'resnet50_silu':  [resnet50_silu, 2048],
    'resnet101_silu': [resnet101_silu, 2048],
}

class MyResNetSiLU(nn.Module):
    def __init__(self, args):
        super(MyResNetSiLU, self).__init__()

        model_fun, self.dim_in = model_dict[args.model]
